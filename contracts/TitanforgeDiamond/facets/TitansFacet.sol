...
contract TitansUpgradeable is ERC721AQueryableUpgradeable, Ownable {
    ...
    uint256 public shardsRequiredToMintOne;
    uint256 public ingotRequiredToMintOne;
    uint256 public numKoboldsRequiredToMintOne;
    ...
    function initERC721A() initializerERC721A  public {
        __ERC721A_init("Titans","TTNS");
        ...
        shardsRequiredToMintOne =3;
        ingotRequiredToMintOne = 200 ether;
        numKoboldsRequiredToMintOne = 1;
        uriSuffix = ".json";
    ...
    function devMint(
        ...
        emit ElementalMint(msg.sender, (supply), shardId, amount);
    ...
    function mint(
        ...
        for (uint256 i; i < koboldIds.length; ++i) {
            if (msg.sender != kobolds.ownerOf(koboldIds[i]))
                revert NotOwner();
        ...
        ingotToken.burn(msg.sender, amount * ingotRequiredToMintOne);
